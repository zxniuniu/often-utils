...
public class App {
	...
	public static final int MAX_THREADS = 8; // 多线程下载,建议4-8
	public static final int DOWN_THREADS = 1; // 单文件下载线程
	public static final int MAX_RETRY = 4; // 最大重试次数
	public static final int MILLISECONDS_SLEEP = 2000; // 重试间隔时间(毫秒)

	public static final boolean errorExit = true; // 下载错误退出程序
