...
public class Base64Utils {
	...
	@NotNull
	@Contract(pure = true)
	public static String encryptToBase64(@NotNull String str, String charsetName) {
	...
	@NotNull
	@Contract(pure = true)
	public static String encryptToBase64(@NotNull String str, Charset charset) {
	...
	@NotNull
	@Contract(pure = true)
	public static String fileEncryptToBase64(@NotNull String filePath) {
		byte[] bytes = null;
		try {
	 ...
	 */
	@Contract(pure = true)
	public static void fileEncryptByBase64(@NotNull String base64, @NotNull String filePath) {
		try {
	...
	@NotNull
	@Contract(pure = true)
	public static String encryptByBase64(@NotNull String base64) {
	...
	@NotNull
	@Contract(pure = true)
	public static String encryptByBase64(@NotNull String base64, @NotNull String charsetName) {
	...
	@NotNull
	@Contract(pure = true)
	public static String encryptByBase64(@NotNull String base64, Charset charset) {
