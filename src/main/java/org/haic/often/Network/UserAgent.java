...
public class UserAgent {
	...
	protected static final String[] winSystem = { "Windows NT 11.0", "Windows NT 10.0", "Windows NT 8.1", "Windows NT 8.0", "Windows NT 7.0", "windows NT 6.2",
			"Windows NT 6.1", "Windows NT 6.0", "Windows NT 5.2", "Windows NT 5.1", "Windows NT 5.0", "Windows ME", "Windows 98" };
	protected static final String[] linuxSystem = { "Ubuntu", "Manjaro Linux", "Pop!_OS", "Deepin", "Debian GNU/Linux", "elementary OS" };
	protected static final String[] linuxCPU = { "Linux x86_64", "Linux i686", "Linux ppc64", "Linux ppc" };
	protected static final String[] language = { "en-us", "zh-cn", "en-GB" };
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String chrome() {
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String fireFox() {
		String result = mozilla + " (";
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String edge() {
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String opera() {
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String safari() {
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String ie() {
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String maxthon() {
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String theWorld() {
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String tt() {
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String threeSixZero() {
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String avent() {
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String uc() {
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String sogu() {
		return mozilla + " (" + compatibleHeader() + winPlatform() + tridentHeader()
	...
	@Contract(pure = true) protected static String macPlatform() {
	...
	@Contract(pure = true) protected static String linuxPlatform() {
		String result = "X11; ";
	...
	@Contract(pure = true) protected static boolean twoSelectOne() {
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String chromeAsPhone() {
	 ...
	 * @return Random UserAgent
	 */
	@Contract(pure = true) public static String safariAsPhone() {
		String result = mozilla + " (";
		switch (RandomUtils.nextInt(0, 3)) {
